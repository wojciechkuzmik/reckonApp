...
from .views import CreateReckoningView,ReckoningView,CreateReckoningPositionView,CreateCategoryView, ReckoningPositionsView,CategoriesView, CategoryView, ReckoningsInGroupView, ReckoningPositionsForUserView,ReckoningPositionsByUserView, CreateReckoningPositionForOneView
...
urlpatterns = [
	...
	path('reckoningPosition', CreateReckoningPositionView.as_view()),	#create reckoningPosition FOR ALL USERS IN GROUP CONNECTED TO THIS RECKONING!!!
	path('reckoningPositionForOne', CreateReckoningPositionForOneView.as_view()),	#create reckoningPosition FOR ONE SPECIFIED USER
